        ...
        <div className="relative mb-8">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-4 md:gap-6 items-center">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <h3 className="text-xl font-bold text-white mb-4">Account 1</h3>
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent text-white placeholder-blue-200"
                  disabled={loading1 || loading2}
                />
              </div>

              {error1 && (
                <div className="mt-4 p-3 bg-red-500/20 border border-red-400/30 rounded-xl text-red-200 text-sm">
                  {error1}
                </div>
              )}
              ...
              {data1 && (
                <div className="mt-6 space-y-4">
                  <div className="text-center">
                    ...
                    <div className="inline-flex items-center bg-yellow-400 text-blue-900 px-4 py-2 rounded-full">
                      <BarChart3 className="h-5 w-5 mr-2" />
                      <span className="font-bold">{data1.engagementRate}%</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-white/10 rounded-xl p-3 text-center">
                      <Heart className="h-5 w-5 text-yellow-400 mx-auto mb-1" />
                      <div className="text-lg font-bold text-white">
            ...
            <div className="hidden md:flex items-center justify-center z-10">
              <div className="bg-yellow-400 text-blue-900 px-6 py-6 rounded-full font-bold text-2xl shadow-2xl min-w-[80px] flex items-center justify-center">
                VS
              </div>
            </div>
            ...
            {/* Account 2 */}
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <h3 className="text-xl font-bold text-white mb-4">Account 2</h3>
              <div className="relative mb-4">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-blue-400" />
                <input
                  type="text"
              ...
              {data2 && (
                <div className="mt-6 space-y-4">
                  <div className="text-center">
                    ...
                    <div className="inline-flex items-center bg-yellow-400 text-blue-900 px-4 py-2 rounded-full">
                      <BarChart3 className="h-5 w-5 mr-2" />
                      <span className="font-bold">{data2.engagementRate}%</span>
                    </div>
                  </div>
          ...
          <div className="mt-6 flex justify-center">
            <button
              ...
              className="bg-yellow-400 hover:bg-yellow-500 text-blue-900 px-12 py-4 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
              {loading1 || loading2 ? (
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>Analyze Both Accounts</span>
                </div>
              )}
            </button>
          </div>
        ...
        {data1 && data2 && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white/10 rounded-xl p-4 text-center">
                <div className="text-sm text-blue-200 mb-2">Followers</div>
                <div className="text-2xl font-bold text-white mb-2">
              ...
              <div className="bg-white/10 rounded-xl p-4 text-center">
                <div className="text-sm text-blue-200 mb-2">Avg Likes</div>
                <div className="text-2xl font-bold text-white mb-2">
              ...
              <div className="bg-white/10 rounded-xl p-4 text-center">
                <div className="text-sm text-blue-200 mb-2">Avg Comments</div>
                <div className="text-2xl font-bold text-white mb-2">
