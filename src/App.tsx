    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 relative overflow-hidden">
      ...
      <nav className="relative z-10 px-6 py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <div className="bg-yellow-400 text-blue-900 px-4 py-2 rounded-full font-bold flex items-center space-x-2">
            ...
            <div className="text-center mt-20 mb-12">
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-12 border border-white/20 max-w-4xl mx-auto">
                ...
                <p className="text-blue-200 text-lg mb-8 max-w-2xl mx-auto">
                  Join thousands of creators who use our analytics to optimize
                  their content strategy and boost engagement rates.
                </p>
